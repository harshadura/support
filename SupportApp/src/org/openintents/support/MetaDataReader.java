...
public class MetaDataReader {
	public static final String ELEM_ABOUT = "support";
	...
	private Bundle createBundle(){
		...
		if(manifestMD.containsKey(SupportMetaData.METADATA_ABOUT)){
			int id = manifestMD.getInt(SupportMetaData.METADATA_ABOUT, -1);
			if(id == -1)
				return null;
